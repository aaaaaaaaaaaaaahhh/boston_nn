...
for i in range(e):
    ...
    loss = final_loss.mean_squared_error(ye_preds, 404)
    losses.append(loss)

    l_prime = final_loss.mean_squared_error_prime(ye_preds, 404)

    layer_3_back = layer_3.backward(l_prime)
    ...
    layer_2_back = layer_2.backward(layer_2_activation_back)
    layer_1_activation_back = layer_1_activation.backward(layer_2_back)
    layer_1_back = layer_1.backward(layer_1_activation_back)
